...
const HERO_VIDEO = '/media/hybrid-battery-diagnostic-loop.mp4'
const HERO_POSTER = '/media/hybrid-battery-diagnostic-poster.jpg'
  ...
  return (
    <div className="relative h-full w-full">
      <Image
        ...
        fill
        sizes="100vw"
        className="hero-poster hidden object-cover motion-reduce:block"
        aria-hidden="true"
        priority
      />
      <video
        ref={videoRef}
        className="hero-loop h-full w-full object-cover motion-reduce:hidden"
        src={HERO_VIDEO}
        poster={HERO_POSTER}
        autoPlay
        muted
          ...
          <div className="order-1 relative mt-0 lg:order-2 lg:mt-0 lg:block">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/15 bg-[#0B1120]/78 p-3 shadow-2xl shadow-teal-950/50 backdrop-blur-xl">
              <div className="relative aspect-video overflow-hidden rounded-[1.45rem] bg-slate-950 lg:aspect-[16/11]">
                <HeroLoop label="Decorative 3D-style hybrid battery diagnostic animation" />
